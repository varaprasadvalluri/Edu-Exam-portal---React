              ...
              return (
                ...
                <div className="flex flex-wrap items-center gap-3 self-end md:self-auto font-sans">
                  ...
                  <Button 
                    ...
                    className="bg-indigo-600 hover:bg-slate-950 text-white font-black text-[10px] uppercase tracking-widest h-10 rounded-xl shadow-md px-4 cursor-pointer flex items-center gap-1.5 group"
                  >
